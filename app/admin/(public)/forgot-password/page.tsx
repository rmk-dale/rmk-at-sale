  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm bg-surface border border-border rounded-2xl p-8">
        <h1 className="text-xl font-semibold text-zinc-900 mb-1">Reset admin password</h1>
        <p className="text-sm text-zinc-500 mb-6">We&apos;ll email you a link if the account exists.</p>
        ...
        <Link href="/admin/login" className="block text-center text-sm text-zinc-500 hover:text-zinc-900 mt-6">
          Back to sign in
        </Link>
      </div>
    </div>
