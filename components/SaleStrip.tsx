...
export default function SaleStrip() {
  ...
  return (
    ...
    >
      <div className="bg-gradient-to-r from-[#cc3f1b] to-[#c7261c]">
      ...
      {CAMPAIGN.note && (
        <div className="bg-neutral-900 text-white">
          <div className="max-w-7xl mx-auto px-6 py-1.5 flex justify-center items-center text-center">
            <span className="text-[11px] sm:text-xs font-medium tracking-wide opacity-90">
              {CAMPAIGN.note}
            </span>
          </div>
        </div>
