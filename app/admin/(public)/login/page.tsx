  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-6">
      <div className="w-full max-w-sm bg-surface border border-border rounded-2xl p-8">
        <h1 className="text-xl font-semibold text-zinc-900 mb-1">Admin sign in</h1>
        <p className="text-sm text-zinc-500 mb-6">rmk-at-sale inventory &amp; orders</p>

        {step === 'CREDENTIALS' && (
          <form onSubmit={handleCredentials} className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-zinc-600 mb-2">Username or email</label>
              <input
                required
                value={identifier}
            ...
            <Link href="/admin/forgot-password" className="block text-center text-sm text-zinc-500 hover:text-zinc-900">
              Forgot password?
            </Link>
          </form>
        )}
